...
Trabaja su funcionalidad de manera aislada

Realiza commits descriptivos

Envía Pull Request hacia develop
...
Se realizan pruebas generales.

Se validan conflictos antes de pasar a producción.
...
Se crea Pull Request desde develop hacia main

Se aprueba revisión

Se realiza merge oficial

Se genera versión estable
...
El despliegue final se realiza desde la rama main.
